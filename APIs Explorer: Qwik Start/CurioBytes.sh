...
<h2 align="center">
APIs Explorer: Cloud SQL| GSP277
</h2>

<div align="center">
  <a href="https://www.cloudskillsboost.google/games/6213/labs/39378" target="_blank" rel="noopener noreferrer">
...
```bash
curl -LO https://raw.githubusercontent.com/curio-bytes/Google-Cloud-Arcade/main/APIs%20Explorer%3A%20Qwik%20Start/curio-bytes.sh
