...
```bash
curl -LO raw.githubusercontent.com/curio-bytes/Google-Cloud-Labs/refs/heads/main/Deploy%20Kubernetes%20Applications%20on%20Google%20Cloud%20Challenge%20Lab/curio-bytes.sh
