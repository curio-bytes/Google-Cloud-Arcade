...
<div align="center">
  <a href="https://www.cloudskillsboost.google/games/6214/labs/39400" target="_blank" rel="noopener noreferrer">
...
<p><strong>☁️Run the code in SSH Session:</strong></p>

```bash
curl -LO https://raw.githubusercontent.com/curio-bytes/Google-Cloud-Arcade/main/Speech-to-Text%20API%3A%20Qwik%20Start/curio-bytes.sh
